...
```bash
git clone https://github.com/soymatta/Agents-Skills && python Agents-Skills/scripts/setup.py
```

Or, if you have the standalone installer in your project root:

```bash
git clone https://github.com/soymatta/Agents-Skills && python setup.py
```
...
**Importante:** el instalador ahora copia los archivos al directorio actual de trabajo
(`Path.cwd()`), no al interior del repositorio clonado. Esto asegura que los agents/skills
se instalen correctamente en la raíz de tu proyecto.
